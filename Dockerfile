FROM ubuntu:18.04
MAINTAINER  sancsamuel@gmail.com
...
RUN apt-get install -y nano apt-transport-https php7.3-bcmath php7.3-bz2 php7.3-cli php7.3-common php7.3-curl \
                php7.3-cgi php7.3-dev php7.3-fpm php7.3-gd php7.3-gmp php7.3-imap php7.3-intl \
                php7.3-json php7.0-ldap php7.3-mbstring php7.3-mysql \
                php7.3-odbc php7.0-opcache php7.0-pgsql php7.3-phpdbg php7.3-pspell \
                php7.3-readline php7.3-recode php7.3-soap php7.3-sqlite3 \
                php7.3-tidy php7.3-xml php7.3-xmlrpc php7.3-xsl php7.3-zip \
                php-tideways php-mongodb php7.3 mcrypt php-pear
...
RUN echo "extension=sqlsrv.so" | tee --append /etc/php/7.3/fpm/php.ini
RUN echo "extension=pdo_sqlsrv.so" | tee --append /etc/php/7.3/fpm/php.ini
...
RUN sed -i "s/display_errors = Off/display_errors = Off/" /etc/php/7.3/fpm/php.ini
